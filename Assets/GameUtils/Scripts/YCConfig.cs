...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class YCConfigEditor : Editor {
            public override void OnInspectorGUI() {
                ...
                if (GUILayout.Button("Activate In App Purchases")) {
                    ...
                    Client.Add("com.unity.purchasing@4.4.1");
#else 
        ...
        public class YCConfig : ScriptableObject {
            ...
            public static string VERSION = "1.33.2";
            ...
            public void InitFacebook() {
                ...
                content = new Regex("com\\.facebook\\.sdk\\.ClientToken\" android:value=\"[0-9a-f]+").Replace(content, "com.facebook.sdk.ClientToken\" android:value=\"" + this.FbClientToken);
            ...
            public void InitAmazon() {
                ...
                System.Xml.XmlDocument manifestFile = new System.Xml.XmlDocument();
                manifestFile.Load(manifestPath);
                System.Xml.XmlElement manifestRoot = manifestFile.DocumentElement;
                System.Xml.XmlNode applicationRoot = manifestRoot.SelectSingleNode("descendant::application");
                ...
                foreach (System.Xml.XmlNode node in manifestRoot.ChildNodes) {
                ...
                foreach (System.Xml.XmlNode node in applicationRoot.ChildNodes) {
                ...
                System.Xml.XmlNodeList refElementsUsesPermission = manifestRoot.SelectNodes("descendant::uses-permission");
                System.Xml.XmlNodeList refElementsActivity = applicationRoot.SelectNodes("descendant::activity");
            ...
            private void AddAndroidName(System.Xml.XmlDocument manifestFile, System.Xml.XmlNode root, System.Xml.XmlNodeList refElements, string elementName, string value) {
#if UNITY_EDITOR
                System.Xml.XmlElement element = manifestFile.CreateElement(elementName);
